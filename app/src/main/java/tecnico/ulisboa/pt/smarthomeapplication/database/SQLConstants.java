...
public class SQLConstants {
    ...
    protected static final String COLUMN_LIGHT_MIN_BRIGHTNESS = "minBrightness";
    protected static final String COLUMN_LIGHT_MAX_BRIGHTNESS = "maxBrightness";
    ...
    protected static final String COLUMN_LIGHT_MIN_TEMPERATURE = "minTemperature";
    protected static final String COLUMN_LIGHT_MAX_TEMPERATURE = "maxTemperature";
    ...
    protected static final String SQL_CREATE_LIGHTS_TABLE = "CREATE TABLE IF NOT EXISTS " + LIGHTS_TABLE + "("
            ...
            + COLUMN_LIGHT_MIN_BRIGHTNESS + " INTEGER NOT NULL,"
            + COLUMN_LIGHT_MAX_BRIGHTNESS + " INTEGER NOT NULL,"
            + COLUMN_LIGHT_COLORSETTING + " INTEGER NOT NULL,"
            + COLUMN_LIGHT_TEMPERATURE + " INTEGER NOT NULL,"
            + COLUMN_LIGHT_MIN_TEMPERATURE + " INTEGER NOT NULL,"
            + COLUMN_LIGHT_MAX_TEMPERATURE + " INTEGER NOT NULL,"
    ...
    protected static final String SQL_SELECT_MIN_BRIGHTNESS_LIGHT = "SELECT " + COLUMN_LIGHT_MIN_BRIGHTNESS + " FROM " + LIGHTS_TABLE + " WHERE " + COLUMN_DEVICE_ID + " = ";
    protected static final String SQL_SELECT_MAX_BRIGHTNESS_LIGHT = "SELECT " + COLUMN_LIGHT_MAX_BRIGHTNESS + " FROM " + LIGHTS_TABLE + " WHERE " + COLUMN_DEVICE_ID + " = ";
    ...
    protected static final String SQL_SELECT_MIN_TEMPERATURE_LIGHT = "SELECT " + COLUMN_LIGHT_MIN_TEMPERATURE + " FROM " + LIGHTS_TABLE + " WHERE " + COLUMN_DEVICE_ID + " = ";
    protected static final String SQL_SELECT_MAX_TEMPERATURE_LIGHT = "SELECT " + COLUMN_LIGHT_MAX_TEMPERATURE + " FROM " + LIGHTS_TABLE + " WHERE " + COLUMN_DEVICE_ID + " = ";
    ...
    protected static final String COLUMN_SENSOR_MIN_HUMIDITY = "minHumidity";
    protected static final String COLUMN_SENSOR_MAX_HUMIDITY = "maxHumidity";
    protected static final String COLUMN_SENSOR_TEMPERATURE = "temperature";
    protected static final String COLUMN_SENSOR_MIN_TEMPERATURE = "minTemperature";
    protected static final String COLUMN_SENSOR_MAX_TEMPERATURE = "maxTemperature";
    ...
    protected static final String SQL_CREATE_SENSORS_TABLE = "CREATE TABLE IF NOT EXISTS " + SENSORS_TABLE + "("
            ...
            + COLUMN_SENSOR_MIN_HUMIDITY + " INTEGER NOT NULL,"
            + COLUMN_SENSOR_MAX_HUMIDITY + " INTEGER NOT NULL,"
            + COLUMN_SENSOR_TEMPERATURE + " INTEGER NOT NULL,"
            + COLUMN_SENSOR_MIN_TEMPERATURE + " INTEGER NOT NULL,"
            + COLUMN_SENSOR_MAX_TEMPERATURE + " INTEGER NOT NULL,"
    ...
    protected static final String SQL_SELECT_MIN_HUMIDITY_SENSOR = "SELECT " + COLUMN_SENSOR_MIN_HUMIDITY + " FROM " + SENSORS_TABLE + " WHERE " + COLUMN_DEVICE_ID + " = ";
    protected static final String SQL_SELECT_MAX_HUMIDITY_SENSOR = "SELECT " + COLUMN_SENSOR_MAX_HUMIDITY + " FROM " + SENSORS_TABLE + " WHERE " + COLUMN_DEVICE_ID + " = ";
    ...
    protected static final String SQL_SELECT_MIN_TEMPERATURE_SENSOR = "SELECT " + COLUMN_SENSOR_MIN_TEMPERATURE + " FROM " + SENSORS_TABLE + " WHERE " + COLUMN_DEVICE_ID + " = ";
    protected static final String SQL_SELECT_MAX_TEMPERATURE_SENSOR = "SELECT " + COLUMN_SENSOR_MAX_TEMPERATURE + " FROM " + SENSORS_TABLE + " WHERE " + COLUMN_DEVICE_ID + " = ";
